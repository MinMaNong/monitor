...
public class Ptz_Direct_Info_t
{
	...
	public Ptz_Direct_Info_t() {
		super();
	}



	public Ptz_Direct_Info_t(byte[] szCameraId, int nDirect, int nStep, boolean bStop) {
		super();
		this.szCameraId = szCameraId;
		this.nDirect = nDirect;
		this.nStep = nStep;
		this.bStop = bStop;
	}
	...
	public Ptz_Direct_Info_t(byte[] szCameraId, int nDirect, int nStep) {
		super();
		this.szCameraId = szCameraId;
		this.nDirect = nDirect;
		this.nStep = nStep;
