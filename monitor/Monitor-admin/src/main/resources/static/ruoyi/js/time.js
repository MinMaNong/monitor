...
+function ($) {
	...
	var months = ['一月','二月','三月','四月','五月','六月','七月','August','九月','October','November','December'],
		short_months = ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','九月','Oct','Nov','Dec'],
		daysofweek = ['星期日','Monday','Tuesday','星期三','Thursday','Friday','Saturday'],
