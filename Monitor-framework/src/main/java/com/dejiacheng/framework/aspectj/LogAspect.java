package com.dejiacheng.framework.aspectj;
...
import com.dejiacheng.common.enums.BusinessStatus;
 ...
 * @author pcy
 * 操作日志记录处理
 * @version 创建时间:2019年9月5日-下午4:01:55
 */
@Aspect
@Component
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.dejiacheng.common.annotation.Log)")
